...
public class Update_Employee extends Add_Employee implements ActionListener{
	...
	JFrame f;
    JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id10,id11,id12,id15,lab,lab1;
    JTextField t,t1,t2,t3,t4,t5,t6,t7,t9,t10,t11;
    JButton b,b1,b2,b3;
    String id_emp;
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource()==b && i==1){
            try{
                connect con = new connect();
                String str = "update employee set name='"+t1.getText()+"',fname='"+t2.getText()+"',age='"+age+"',dob='"+dat+"',address='"+t3.getText()+"',phone='"+t4.getText()+"',email='"+t5.getText()+"',education='"+t6.getText()+"',post='"+t7.getText()+"',emp_id='"+t9.getText()+"' where emp_id='"+id_emp+"'";
